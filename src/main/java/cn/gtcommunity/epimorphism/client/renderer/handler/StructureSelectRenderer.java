...
import cn.gtcommunity.epimorphism.client.utils.EPRenderBufferHelper;
...
public class StructureSelectRenderer {
    public static void render(RenderWorldLastEvent event) {
        ...
        if (StructureWriteBehavior.isItemStructureWriter(held)) {
            ...
            EPRenderBufferHelper.renderCubeFace(buffer, poses[0].getX(), poses[0].getY(), poses[0].getZ(), poses[1].getX() + 1, poses[1].getY() + 1, poses[1].getZ() + 1, 0.2f, 0.2f, 1f, 0.25f, true);
            ...
            EPRenderBufferHelper.renderCubeFrame(buffer, poses[0].getX(), poses[0].getY(), poses[0].getZ(), poses[1].getX() + 1, poses[1].getY() + 1, poses[1].getZ() + 1, 0.0f, 0.0f, 1f, 0.5f);
