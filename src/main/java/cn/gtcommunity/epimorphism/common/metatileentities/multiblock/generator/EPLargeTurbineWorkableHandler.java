...
public class EPLargeTurbineWorkableHandler extends MultiblockFuelRecipeLogic {
    private final int BASE_EU_OUTPUT;

    private int excessVoltage;

    public EPLargeTurbineWorkableHandler(RecipeMapMultiblockController metaTileEntity, int tier) {
    ...
    public long getMaxVoltage() {
        IRotorHolder rotorHolder = ((EPMetaTileEntityLargeTurbine) metaTileEntity).getRotorHolder();
