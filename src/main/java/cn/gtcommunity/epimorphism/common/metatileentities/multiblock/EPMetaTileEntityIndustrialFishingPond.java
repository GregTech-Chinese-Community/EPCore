...
public class EPMetaTileEntityIndustrialFishingPond extends MultiblockWithDisplayBase implements IWorkable, IDataInfoProvider {
    ...
    public EPMetaTileEntityIndustrialFishingPond(ResourceLocation metaTileEntityId) {
        super(metaTileEntityId);
        this.logic = new FishingPondLogic(this, GTValues.IV);
    }

    @Override
    public MetaTileEntity createMetaTileEntity(IGregTechTileEntity iGregTechTileEntity) {
        return new EPMetaTileEntityIndustrialFishingPond(metaTileEntityId);
    }
    ...
    public List<ITextComponent> getDataInfo() {
        ...
        list.add(new TextComponentTranslation("epimorphism.machine.multiblock.mode", logic.getMode()));
        return list;
    }
