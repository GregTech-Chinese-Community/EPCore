...
public class EPMetaTileEntityFracker extends MultiblockWithDisplayBase implements IWorkable, ITieredMetaTileEntity {
    ...
    public EPMetaTileEntityFracker(ResourceLocation metaTileEntityId, int tier) {
    ...
    public void addInformation(ItemStack stack, @Nullable World player, @Nonnull List<String> tooltip, boolean advanced) {
        ...
        tooltip.add(I18n.format("epimorphism.multiblock.fracker.tooltip.1"));
        tooltip.add(I18n.format("epimorphism.multiblock.fracker.tooltip.2", TextFormattingUtil.formatNumbers(GTValues.VA[tier])));
    }
